...
excerpt: >
 A passive detection system capable of identifying Drones through the characteristic ELF magnetic signatures generated by drone motors.
order: 10
---
...
This work is **Accepted for Publication at IEEE Sensors Journal (Q1)** (Impact Factor-4.5) and preprint is available [here](https://drive.google.com/file/d/1IEhtpIPU5mk340E3WVjDRBGQR3pv2-cb/view?usp=drive_link).
...
<div class="project-gallery" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 1.5rem; margin: 2rem 0;">
  ...
  <figure>
    <img src="/images/projects/FYP/IMG_0580.JPG" alt="Altium-designed analog frontend PCB" style="width: 100%; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.1);">
