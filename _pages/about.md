...
<!-- <div style="display:grid;grid-template-columns:repeat(auto-fit,minmax(240px,1fr));gap:1rem;align-items:start;">
  <figure style="margin:0;">
    <img src="/images/photo1.jpg" alt="Conference photo 1" style="width:100%;height:auto;border-radius:8px;">
  ...
  <figure style="margin:0;">
    <img src="/images/photo2.jpg" alt="Conference photo 2" style="width:100%;height:auto;border-radius:8px;">
